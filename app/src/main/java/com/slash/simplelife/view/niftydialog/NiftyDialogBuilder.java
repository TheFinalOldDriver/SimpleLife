package com.slash.simplelife.view.niftydialog;
...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    /**
     * 这里不用单例，因为会造成当前ACTIVITY杀死时，context
     * 未结束，导致第二次进入这个ACTIVITY时再次点击弹出对话框。
     * 单例，导致context一直是上次已经被destroy的activity的。
     * 会报窗体溢出的错，这时如果try-catch了也只会让dialog无法弹出
     * @param context
     */
