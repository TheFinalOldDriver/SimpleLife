...
public class ViewAnimation {
    ...
    private View onView;
    private ArrayList<ArrayList<com.nightonke.wowoviewpager.PageAnimation>> pageAnimations;
     ...
     */
    public void addPageAnimaition(com.nightonke.wowoviewpager.PageAnimation pageAnimation) {
        int page = pageAnimation.getPage();

        if (pageAnimations == null) pageAnimations = new ArrayList<>();
        while (page + 1 > pageAnimations.size()) {
            pageAnimations.add(new ArrayList<com.nightonke.wowoviewpager.PageAnimation>());
        }

        ArrayList<com.nightonke.wowoviewpager.PageAnimation> pageAnimationsInPage = pageAnimations.get(page);
    ...
    public void play(int page, float positionOffset) {
        ...
        if (pageAnimationsInPage != null) {
            for (com.nightonke.wowoviewpager.PageAnimation pageAnimation : pageAnimationsInPage) {
